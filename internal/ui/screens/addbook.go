...
func (m AddBookModel) View() string {
	...
	b.WriteString("\n")
	b.WriteString(styles.HelpTextStyle.Render(styles.AddLetterSpacing("Press Esc to return to menu, Ctrl+A/Ctrl+E for start/end of field, q or Ctrl+C to quit")))
